...
class operations:
        ...
        def modify(self,privilege):
            ...
            print("what do you want to modify, please select option from the below menu,")
            print("1. Address")
...
class TeacherMode(operations):
    
    def teacher(self):
        print("Hi")
        print("Do you want add or remove any student, then give Add or Remove")
        print("")
        print("Do you want access the details of the student, then give Access")
        print("")
        print("Do you want modify the details of the student, then give Modify")
        print("")
